            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <form action="/booking/{{ $edit->id }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tanggal_booking"
                                                    value="{{ old('tanggal_booking', $edit->tanggal_booking) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="jam_booking"
                                                value="{{ old('jam_booking', $edit->jam_booking) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="pembayaran_booking"
                                                ...
                                                <option value=""
                                                    {{ old('pembayaran_booking', $edit->pembayaran_booking) == '' ? 'selected' : '' }}>
                                                    -
                                                    Pilih Pembayaran -</option>
                                                <option value="0"
                                                    {{ old('pembayaran_booking', $edit->pembayaran_booking) == '0' ? 'selected' : '' }}>
                                                    Cash</option>
                                                <option value="1"
                                                    {{ old('pembayaran_booking', $edit->pembayaran_booking) == '1' ? 'selected' : '' }}>
                                                    Transfer</option>
                                            </select>
