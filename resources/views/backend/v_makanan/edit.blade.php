            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <form action="/makanan/{{ $edit->id }}" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{-- view image --}}
                                                    @if ($edit->foto)
                                                        <img src="{{ asset('storage/img-makanan/' . $edit->foto) }}"
                                                            class="foto-preview" width="100%">
                                                        <p></p>
                                                    @else
                                                        <img src="{{ asset('storage/img-makanan/img-default.jpg') }}"
                                                            class="foto-preview" width="100%">
                                                        <p></p>
                                                    @endif
                                                    {{-- file foto --}}
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_makanan"
                                                            value="{{ old('nama_makanan', $edit->nama_makanan) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="harga_makanan"
                                                        value="{{ old('harga_makanan', $edit->harga_makanan) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="deskripsi_makanan"
                                                        value="{{ old('deskripsi_makanan', $edit->deskripsi_makanan) }}"
