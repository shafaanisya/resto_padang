            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <form action="/promo/{{ $edit->id }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_promo"
                                                value="{{ old('nama_promo', $edit->nama_promo) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="diskon_promo"
                                                value="{{ old('diskon_promo', $edit->diskon_promo) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="deskripsi_promo"
                                                value="{{ old('deskripsi_promo', $edit->deskripsi_promo) }}"
