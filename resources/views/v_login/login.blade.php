    ...
    <div class="wrapper vh-100">
        <div class="row align-items-center h-100">
            <form action="{{ route('login') }}" class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST">
                @csrf
                <a class="navbar-brand flex-fill mx-auto mt-2 text-center" href="{{ route('login') }}">
                ...
                <p class="mt-3">
                    <a href="" class="text-center">Dont have account? Please Register first!</a>
                </p>
                <p class="text-muted mb-3 mt-5"> Ben in Shaf © 2024</p>
            </form>
        </div>
    </div>
